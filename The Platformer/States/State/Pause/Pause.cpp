...
void Pause::Update() {
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Escape) && KeyCheck::Key('/')) {
...
void Pause::InitButtons() {
	...
	{
		{ "resume",		  Button("CONTINUER",		 sf::Vector2f(WINDOW_WIDTH / 2.0f, 400), m_FontManager.Get("default")) },
		{ "settings",	  Button("OPTIONS",	 sf::Vector2f(WINDOW_WIDTH / 2.0f, 500), m_FontManager.Get("default")) },
		{ "exit_to_menu", Button("REVENIR AU MENU", sf::Vector2f(WINDOW_WIDTH / 2.0f, 600), m_FontManager.Get("default")) },
	};
